...
const VideoProcess = () => {
  ...
  const handleMouseMove = (e) => {
    if (currentShape) {
      ...
      if (shapeType === 'freeform') {
        const updatedShape = { ...currentShape, vertices: [...currentShape.vertices, { x, y }] };
  ...
  const drawShape = (shape, isSelected) => {
    ...
    if (type === "rectangle") {
      ...
      return <Rect x={startX} y={startY} width={width} height={height} {...commonProps} />;
        ...
        >
          <div style={styles.toolbar}>
            <button 
              ...
              style={shapeType === "rectangle" ? { ...styles.button, backgroundColor: '#3f3178' } : styles.button}>
                <RiRectangleFill className="ShapeIcons"/>
            </button>
            <button 
              onClick={() => setShapeType("triangle")} 
              style={shapeType === "triangle" ? { ...styles.button, backgroundColor: '#3f3178' } : styles.button}>
                <IoTriangleOutline />
            </button>
            <button 
              onClick={() => setShapeType("freeform")} 
              style={shapeType === "freeform" ? { ...styles.button, backgroundColor: '#3f3178' } : styles.button}>
                <FaPencilAlt />
            </button>
          ...
          <svg ref={svgRef} style={styles.canvas} onClick={() => setSelectedShapeIndex(null)}>
  ...
  {currentShape && drawShape(currentShape)}
            ...
            <button onClick={makeImage} style={styles.button}>
              Continue
            </button>
          </div>
        </div>
